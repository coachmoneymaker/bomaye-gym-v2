    ...
    var html = [
      ...
      '<div id="cookie-banner" role="region" aria-label="Cookie-Hinweis">',
        '<div class="cb-text-block">',
          ...
          '<p class="cb-text">Wir verwenden Cookies, um die Website zu optimieren und dir relevante Inhalte zu zeigen. Du kannst deine Auswahl jederzeit anpassen. Mehr in der <a href="/datenschutz">Datenschutzerklärung</a>.</p>',
        '</div>',
